  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        toast.success('Account created successfully! Welcome to Jona Crest Properties.');
        navigate('/');
      } else {
            ...
            >
                ...
                >
                  ...
                  >
                    <img 
                      ...
                      className="w-14 h-14 object-contain rounded-2xl shadow-lg group-hover:shadow-xl transition-shadow"
                    />
                    <motion.div
                      animate={{ scale: [1, 1.2, 1], rotate: [0, 180, 360] }}
                      transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
                      className="absolute -top-2 -right-2 text-[#c9a227]"
                    >
                      <Sparkles className="w-4 h-4" />
                    </motion.div>
                  </motion.div>
                  <h1 className="text-2xl font-bold">
                    <span className="text-[#00796b]">Jona Crest</span>
                    <span className="text-gray-700 ml-2">Properties</span>
                  </h1>
                </motion.div>
              </Link>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center space-x-6 mt-4 text-sm text-gray-500">
                  ...
                  <div className="flex items-center space-x-1">
                    <Shield className="w-4 h-4 text-[#00796b]" />
                    <span>Secure</span>
                  </div>
                  <div className="flex items-center space-x-1">
