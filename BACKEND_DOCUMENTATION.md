# JonaCrest Backend Documentation
...
<div align="center">
  ...
  <h2>🏠 JonaCrest Backend API</h2>
  
  > Complete guide to setup and run the JonaCrest backend server
...
3. Use: `MONGO_URI=mongodb://localhost:27017/JonaCrest`
...
# Run the container
docker run -p 4000:4000 --env-file .env.local JonaCrest-backend

# Run in background
docker run -d -p 4000:4000 --env-file .env.local JonaCrest-backend
```
...
MONGO_URI=mongodb://host.docker.internal:27017/JonaCrest
...
docker build -t JonaCrest-backend:prod .

# Run with production environment
docker run -d -p 4000:4000 --env-file .env.production JonaCrest-backend:prod
```
...
<div align="center">
  <p>Built with ❤️ by the JonaCrest Team</p>
  <p>
    <a href="https://github.com/AAYUSH412/Real-Estate-Website">GitHub</a> •
    <a href="https://JonaCrest.vercel.app">Live Demo</a> •
