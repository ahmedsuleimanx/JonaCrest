# 🏠 JonaCrest - Complete Project Setup & Running Guide
...
JonaCrest is a modern, full-stack real estate platform consisting of three interconnected applications:
...
```
JonaCrest Platform Architecture
├── Frontend (React + Vite) 🌐
│   ├── Port: 5173
...
cd frontend
docker build -t JonaCrest-frontend .
docker run -p 5173:5173 JonaCrest-frontend

# Build and run admin
cd admin
docker build -t JonaCrest-admin .
docker run -p 5174:5174 JonaCrest-admin
```
