# 🚀 How to Run JonaCrest Project - Complete Guide



This guide provides step-by-step instructions to run the complete JonaCrest real estate platform locally.

## 📋 Project Components

JonaCrest consists of three main applications:
...
MONGO_URI=mongodb://localhost:27017/JonaCrest
```
