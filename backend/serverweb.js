  ...
  return `<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <title>Jona Crest Properties API - Backend Dashboard</title>
      ...
      <body>
        <div class="dashboard">
          <div class="header">
            <h1>🏠 Jona Crest Properties API</h1>
          ...
          <div class="content">
            ...
            <div class="info-section">
              ...
              <p>Jona Crest Properties is a comprehensive real estate platform that combines modern web technologies with AI-powered property analysis to deliver an exceptional user experience.</p>
          ...
          <div class="footer">
            <p>© ${new Date().getFullYear()} Jona Crest Properties. All rights reserved. | 
