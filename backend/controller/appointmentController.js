...
export const updateAppointmentStatus = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: `Viewing Appointment ${status.charAt(0).toUpperCase() + status.slice(1)} - Jona Crest Properties`,
...
export const scheduleViewing = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: req.user.email,
      subject: "Viewing Scheduled - Jona Crest Properties",
...
export const cancelAppointment = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: appointment.userId.email,
      subject: 'Appointment Cancelled - Jona Crest Properties',
      html: `
...
export const updateAppointmentMeetingLink = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: appointment.userId.email,
      subject: "Meeting Link Updated - Jona Crest Properties",
      html: `
