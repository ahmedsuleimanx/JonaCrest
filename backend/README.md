...
PORT=4000
APP_NAME=JonaCrest API

# Database Configuration
MONGODB_URI=mongodb://localhost:27017/JonaCrest
# Or MongoDB Atlas
# MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/JonaCrest?retryWrites=true&w=majority
...
# Start application
pm2 start server.js --name JonaCrest-api
...
```bash
NODE_ENV=production
MONGODB_URI=mongodb+srv://user:pass@cluster.mongodb.net/JonaCrest
...
**Powering JonaCrest with robust API architecture**
