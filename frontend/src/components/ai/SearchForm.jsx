...
import { Search, Home, MapPin, Tag, Building } from 'lucide-react';
...
const SearchForm = ({ onSearch, isLoading }) => {
  ...
  const popularCities = ['Accra', 'Kumasi', 'Tema', 'Takoradi', 'Cape Coast', 'Tamale'];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div>
            <label className="flex items-center text-sm font-medium text-gray-700 mb-2 sm:mb-4">
              <Tag className="w-4 h-4 mr-1.5 text-blue-600" />
              Price Range: {currencySymbol}{(searchParams.maxPrice / 1000).toFixed(0)}k
            </label>
            <input
              type="range"
              min="50000"
