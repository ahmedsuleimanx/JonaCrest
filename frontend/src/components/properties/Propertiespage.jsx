    ...
    try {
      ...
      if (response.data.success) {
        setPropertyState((prev) => ({
          ...prev,
          properties: response.data.products || response.data.property || [],
          error: null,
          loading: false,
        }));
      } else {
    ...
    return propertyState.properties
      .filter((property) => {
        ...
        const regionMatch = !filters.region ||
           property.address?.region?.toLowerCase() === filters.region.toLowerCase();
        ...
        return searchMatch && typeMatch && listingTypeMatch && regionMatch && priceMatch && 
